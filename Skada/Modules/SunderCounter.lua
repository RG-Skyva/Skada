...
Skada:RegisterModule("Sunder Effective Counter", function(L, P, _, C, M, O)
	local mode = Skada:NewModule("Sunder Effective Counter")
	...
	function mode:Update(win, set)
		double_check_sunder()
		win.title = L["Sunder Effective Counter"]
